      ...
      <div className="flex flex-col gap-1.5 shrink-0">
        <div className="flex items-center gap-2">
          <input
            ...
            className={cn(
              "w-4 h-4 rounded border border-border bg-surface text-primary focus:ring-2 focus:ring-primary/20 focus:outline-none transition-colors cursor-pointer accent-primary",
              className
            )}
            {...props}
          />
